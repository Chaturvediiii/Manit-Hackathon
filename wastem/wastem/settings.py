"""
Django settings for wastem project.
...
SECRET_KEY = 'django-insecure-^rcscsyjut)0c45*15fn5#3hdpx!p-=ire0&*^lzw%=-3+#hq*'
...
WSGI_APPLICATION = 'wastem.wsgi.application'
